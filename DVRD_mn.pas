...
uses
  ...
  TeeProcs, Chart, DbChart, AxCtrls, OleCtrls, ActnList,
  Cor_Varb,
  ActnMan, TeeSurfa, TeePoin3, TeeFunci, Math, TeeTools, TeeBoxPlot,
  StatChar, CurvFitt, XPStyleActnCtrls, TeeMapSeries, TeeURL, TeeSeriesTextEd;
...
begin
  ...
  repeat
    ...
    begin
      I:=I+1;
      Component[I]:=dmCor.cdsCoranChemSampleNum.AsString;
      for J:=1 to Nox do
      begin
  ...
  begin
    ...
    begin
      ...
      PrintM(Component,X,NumSamples,Nox);
    end;
  end;
  for I:=1 to Nox do
  begin
  ...
  begin
    ...
    begin
      Writeln(Lst,'Factor loadings  -  columns = factors, rows = samples');
      PrintM(Component,B,NumSamples,Nox);
    end;
  end;
...
begin
  ...
  try
    ADODataLinkFile := AppIni.ReadString('ADO','Data link file','C:\Program Files\EggSoft\Coran\Database\Coran.udl');
...
begin
  ...
  dmFlex.SaveDialogFlex.FileName := 'Data_Transformed_1.xls';
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Data_Summary_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Data_4D_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Scores_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Eigenvalues_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Eigenvectors_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Similarity_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Loadings_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
begin
  ...
  dmFlex.SaveDialogFlex.InitialDir := ExportPath;
  dmFlex.SaveDialogFlex.FileName := 'Data_transformed_discretised_1.xls';
  if dmFlex.SaveDialogFlex.Execute then
  begin
    ExportPath := ExtractFilePath(dmFlex.SaveDialogFlex.FileName);
...
// map shapes "Z" values.
  ...
  begin
    {
    tmp:=ChangeFileExt(UserSession.MapFileName,'.dbf');
    }
...
begin
  try
    ...
    begin
      ...
      try
         LoadMap(Series6,UserSession.MapFileName,dmgDV.cdsTable1,MapFieldName,MapValueFieldName,tmp)
      finally
        dmgDV.cdsTable1.Close;
      end;
    end else
